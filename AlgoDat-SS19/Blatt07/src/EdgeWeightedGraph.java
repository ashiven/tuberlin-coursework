...
// Therefore, the documentation does not apply anymore (e.g. file format).
// Please refer to the description on the exercise sheet.

/******************************************************************************
 *  Compilation:  javac EdgeWeightedGraph.java
 *  Execution:    java EdgeWeightedGraph filename.txt
 *  Dependencies: Bag.java Edge.java In.java System.out.java
...
public class EdgeWeightedGraph {
    ...
    private double[][] coord; // saves the R^n coordinates of your nodes.
    private final int V;
    private int E;
