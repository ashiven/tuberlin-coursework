...
public class FlowApplications {
    ...
    /**
     * numberOfEdgeDisjointPaths() returns the (maximum) number of edge-disjoint
     * paths that exist in
    ...
    public static int numberOfEdgeDisjointPaths(Graph graph, int s, int t) {
        FlowNetwork fg = new FlowNetwork(graph.V());
    }

    /**
     * edgeDisjointPaths() returns a maximal set of edge-disjoint paths that exist
     * in
     * an undirected graph between two nodes s and t using Edmonds-Karp.
     *
     * @param graph the graph that is to be investigated
    ...
    public static void main(String[] args) {
         ...
         * // Flussgraph1 is non-unique, so findBottlenecks() should be tested with
         * Flussgraph2
