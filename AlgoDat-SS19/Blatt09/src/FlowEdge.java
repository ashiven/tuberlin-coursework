...
public class FlowEdge {
     ...
     *         same vertex)
     * @throws IllegalArgumentException if {@code vertex} is not one of the
     *                                  endpoints
     *                                  of the edge
     */
     ...
     *         {@code capacity() - flow()}; if {@code vertex} is the head vertex,
     *         the
     ...
     * If {@code vertex} is the tail vertex, this increases the flow on the edge by
     * {@code delta};
     * if {@code vertex} is the head vertex, this decreases the flow on the edge by
     * {@code delta}.
     * 
     * @param vertex one endpoint of the edge
     ...
     *                                  on the edge either negative or larger than
     *                                  its capacity
