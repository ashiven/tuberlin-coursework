/**
 * Move formalizes the mvoe of a robot, specified by the index of the robot and
 * the direction.
 * A move has only a specific meaning in the combination with a 'board' object.
 * The current
 * location of the robot is taken from that board, and the end position of the
 * move is
 * determined by taking into account the walls and positions of other robots on
 * that board.
 */
public class Move {
