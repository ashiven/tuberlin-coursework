...
public class RicochetRobots {
    ...
    /**
     * Find the shortest move sequence for the given board situation to the goal
     * state,
     * i.e., the designated robot has reached the target field.
     * The task is accomplished by using breadth-first-search. In order to avoid
     * checking
     * the same situations over and over again, each investigated board is put in a
     * hash set.
     *
     * @param board Initial configuration of the game.
     * @return The partial solution containing the the shortest move sequence to the
     *         target
     */
