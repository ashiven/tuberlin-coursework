...
builtin.module {
  "choco.ast.program"() ({
    ...
    "choco.ast.assign"() ({
      ...
      "choco.ast.id_expr"() <{"id" = "j"}> : () -> ()
    }) : () -> ()
    "choco.ast.assign"() ({
      "choco.ast.id_expr"() <{"id" = "i"}> : () -> ()
    }, {
      "choco.ast.id_expr"() <{"id" = "k"}> : () -> ()
    }) : () -> ()
  }) : () -> ()
}
...
// CHECK-NEXT:     }, {
// CHECK-NEXT:       "choco.ast.id_expr"() <{"id" = "j", "type_hint" = !choco.ir.list_type<!choco.ir.named_type<"int">>}> : () -> ()
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:     "choco.ast.assign"() ({
// CHECK-NEXT:       "choco.ast.id_expr"() <{"id" = "i", "type_hint" = !choco.ir.named_type<"object">}> : () -> ()
// CHECK-NEXT:     }, {
// CHECK-NEXT:       "choco.ast.id_expr"() <{"id" = "k", "type_hint" = !choco.ir.list_type<!choco.ir.list_type<!choco.ir.named_type<"int">>>}> : () -> ()
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:   }) : () -> ()
// CHECK-NEXT: }
