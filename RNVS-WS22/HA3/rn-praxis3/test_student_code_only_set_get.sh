...
tmux split-window -h -t peers
tmux send-keys "sleep 15 && echo 'You have invited all my friends!' | ./build/client $IP $PORT0 SET Good Thinking! && sleep 2 && ./build/client $IP $PORT3 GET Good Thinking!" C-m
